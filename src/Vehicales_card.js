...
export default function Cour_dynamic(prop) {
    ...
    return (<div className=" col-12 col-sm-12 col-md-6 col-lg-4">
        ...
        <Card className=" col-12 col-sm-12 col-md-12 col-lg-12 mt-3 text-center crd border border-dark zoom"  >
            <Card.Body>
            <div className="zoom">
           
            <Card.Img variant="top" src={process.env.PUBLIC_URL+veh}  style={{ height: '100px',width: '100%'}} className="zoom"/>
            </div>
                ...
                <a href="#ck" type="button" variant="info" className="btn btn-sm btn-primary" id={prop.name} value="bigb" onClick={() => submit(prop.name)}>Detail</a>
            </Card.Body>
        </Card>
